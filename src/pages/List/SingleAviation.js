...
import AviationModal from '../../components/list/Aviation/AviationModal';
import QuestionModal from '../../components/list/Aviation/Question';
import StatusModal from '../../components/list/Aviation/Status';
const SingleAviation = () => {
        ...
        <>
            <div className=' bg-gray-50 min-h-screen'>
                    <div className='py-6 bg-white'>
                        <div className='flex justify-between items-center mx-auto m-auto w-[85%]'>
                ...
                <div className="m-auto w-[85%]">
                    <div className="">
                        <div className=' m-auto py-4 mt-3 '>
            ...
            <AviationModal open={open} setOpen={setOpen} handleOpen={handleOpen} handleClose={handleClose} trigger={trigger} />
