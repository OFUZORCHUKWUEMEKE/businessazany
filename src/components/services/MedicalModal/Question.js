                ...
                <Box sx={style}>
                    ...
                    <div className="py-2 flex items-center space-x-4">
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            <TextField id="outlined-basic" label="Service Rendered" placeholder='Service Rendered' variant="outlined"  className="w-full"/>
                            <TextField id="outlined-basic" label="Description" placeholder='Description' variant="outlined" className="w-full" />
